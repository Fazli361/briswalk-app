          ...
          {!isAuthenticated ? (
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        Urus URL Google Sheet &amp; Web App Apps Script
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-emerald-600 transition group-hover:translate-x-0.5" />
                ...
                {/* Butang Buka Google Sheet Terus (Jika URL Disediakan) */}
                {spreadsheetUrl && spreadsheetUrl.trim() && (
                  <a
                    href={spreadsheetUrl.trim()}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full p-4 rounded-2xl border-2 border-emerald-200 bg-emerald-50/40 hover:bg-emerald-100/50 transition flex items-center justify-between text-left group cursor-pointer"
                  >
                    <div className="flex items-center gap-3.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-emerald-800 mt-0.5">
                          Lihat pangkalan data rekod penyertaan dalam Google Sheet
                        </p>
                      </div>
                    </div>
                    <ExternalLink className="w-5 h-5 text-emerald-600 group-hover:translate-x-0.5 transition" />
                  </a>
                )}
