...
import { formatDisplayDate } from '../services/sheetService';
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end flex-wrap">
            {onRefreshFromSheet && (
              <button
                ...
                disabled={isSyncing}
                title="Segerak rekod terkini dari Google Sheet"
                className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs sm:text-sm transition cursor-pointer shadow-xs border border-slate-300 disabled:opacity-50"
              >
